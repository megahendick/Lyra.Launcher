...
public static class DiscordRPC
    {
        ...
        private static void TimerElapsed(object sender, ElapsedEventArgs e)
        {
            ...
            {
                SetPresence("Playing Minecraft " + MainWindow.CurrentVersion, "None", "lyra_logo", "Lyra Client");
                
                /*var ip = readIp();
                if (ip != previousContent || Minecraft.IsGameOpen())
                {

                    var a = GetServerInfo(ip);
                    previousContent = ip; // Add this line to update previousContent
                    if (a.largeImageKey == "lyra_logo")
                    {
                        a.largeImageKey = "mcicon";
                    }

                    SetPresence(a.Detail, a.largeImageKey, "lyra_logo", a.ipAddress);
                }*/
            }
            else
            {
        ...
        {
            SetPresence("In Launcher", "None", "lyra_logo", "Lyra Launcher");
        }

        private static void InitializeDiscordClient()
        {
            client = new DiscordRpcClient("1219772936580497478");
        ...
        private static void SetPresence(string details, string smallKey, string bigKey, string bigimgText)
        {
            ...
            if (currentPresence == null)
            {
                ...
                {
                    Label = "Download",
                    Url = "https://discord.gg/lyraclient"
